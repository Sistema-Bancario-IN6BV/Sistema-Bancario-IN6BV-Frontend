            ...
            <form onSubmit={handleSubmit} className="space-y-4 bg-bg-card p-6 rounded-lg border border-accent/10 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <input name="username" value={form.username} onChange={handleChange} className="mt-1 input-base" />
                    </div>
                    <div>
                        <label className="block text-sm text-text-muted">Email</label>
                        <input name="email" value={form.email} readOnly className="mt-1 input-base bg-gray-100" />
                    </div>
                    <div>
                        <label className="block text-sm text-text-muted">Teléfono</label>
                        <input name="phone" value={form.phone} onChange={handleChange} className="mt-1 input-base" />
                    </div>
                    <div>
                        <label className="block text-sm text-text-muted">DPI</label>
                        <input name="dpi" value={form.dpi} onChange={handleChange} className="mt-1 input-base" />
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <input name="address" value={form.address} onChange={handleChange} className="mt-1 input-base" />
                </div>
